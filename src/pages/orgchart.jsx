...
const branchColors = {
  ...
  "Director - AI Labs (Products & Solutions)": "bg-gradient-to-br from-purple-600 to-purple-400",
  "Frontend & Backend Development Manager": "bg-gradient-to-br from-purple-600 to-purple-400",
  "Delivery and Deployment Manager": "bg-gradient-to-br from-purple-600 to-purple-400",
  "Deployment Engineers": "bg-gradient-to-br from-purple-600 to-purple-400",
  ...
  "AI Solution Manager": "bg-gradient-to-br from-purple-600 to-purple-400",
