...
const defaultOrgData = {
  ...
  children: [
    {
      name: "Director - AI Labs (Products & Solutions)",
      attributes: { title: "" },
      children: [
        {
          name: "Frontend & Backend Development Manager",
        ...
        {
          name: "Delivery and Deployment Manager",
          attributes: { title: "Team" },
          children: [
            {
              name: "ML and AI Engineers",
            ...
            {
              name: "Deployment Engineers",
              attributes: { title: "Team" },
              pseudoChildren: [
                {name:"",attributes:{title:"Team"}},
                {name:"",attributes:{title:"Team"}},
              ],
            },
          ],
        },
        { name:"AI Solution Manager",
          attributes:{ title:"Team" },
          children:[
